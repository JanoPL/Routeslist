...
namespace Web.Application.Factory
{
    public class PlaywrightFixture : IAsyncLifetime
    {
        ...
        private Task<IBrowser> SelectBrowserAsync(BrowserEnums browser)
        {
            if (
                ChromiumBrowser != null
                && FirefoxBrowser != null
                && WebkitBrowser != null
                && ChromiumBrowser.IsValueCreated 
                && FirefoxBrowser.IsValueCreated
                && WebkitBrowser.IsValueCreated
            ) {
                return browser switch {
                    BrowserEnums.Chromium => ChromiumBrowser.Value,
                    BrowserEnums.Firefox => FirefoxBrowser.Value,
                    BrowserEnums.Webkit => WebkitBrowser.Value,
